            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="full_name" class="block mt-1 w-full" required>
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label>Age</label>
                            <input type="number" name="age" class="block mt-1 w-full" required>
                        </div>
                        <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label>Neighborhood (Residence)</label>
                        <input type="text" name="neighborhood" class="block mt-1 w-full" required>
                    </div>
